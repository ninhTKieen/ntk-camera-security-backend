...
export class Db1733982020698 implements MigrationInterface {
  name = 'Db1733982020698';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "recognized_faces" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "createdById" integer, "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedById" integer, "deletedAt" TIMESTAMP, "deletedById" integer, "id" SERIAL NOT NULL, "name" character varying(100) NOT NULL, "description" character varying(255), "idCode" text NOT NULL, "imageUrl" character varying(255), "isActive" boolean NOT NULL DEFAULT true, "estateId" integer NOT NULL, CONSTRAINT "PK_6b11d8e03f149fcc7c4f0fcbca4" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "devices" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "createdById" integer, "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedById" integer, "deletedAt" TIMESTAMP, "deletedById" integer, "id" SERIAL NOT NULL, "name" character varying(100) NOT NULL, "description" character varying(255), "streamLink" character varying(255) NOT NULL, "model" character varying, "serial" character varying, "brand" character varying, "mac" character varying, "faceRecognitionEnabled" boolean NOT NULL DEFAULT false, "estateId" integer NOT NULL, "areaId" integer, CONSTRAINT "PK_b1514758245c12daf43486dd1f0" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
